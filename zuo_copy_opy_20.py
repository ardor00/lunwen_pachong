...
def writepdf(info):
    ...
    html = etree.HTML(html1)
    index = html.xpath('/html/body/div/div/div/a[4]/@href')  # 年份不同这里需要修改2017-2018是 a[3] 2019 是 a[5]
    ...
    option.add_experimental_option('prefs', {
        "download.default_directory": "F:\\paper\\paper\\2020\\test",
    ...
    download_dir = "F:\\paper\\paper\\2020\\test"
